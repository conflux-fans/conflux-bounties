...
export class Application {
  ...
  private setupRoutes(): void {
    ...
    this.app.use("/api/v1/metrics", metricRoutes(this.metricRepo, this.nodeRepo));
  ...
  private async seedDemoData(): Promise<void> {
    ...
    /** Create demo nodes */
    const demoNodes = [
      { name: "Conflux Core Mainnet", rpcUrl: "https://main.confluxrpc.com", spaceType: "core" as const, enabled: true },
      { name: "Conflux eSpace Mainnet", rpcUrl: "https://evm.confluxrpc.com", spaceType: "espace" as const, enabled: true },
      { name: "Conflux Core Testnet", rpcUrl: "https://test.confluxrpc.com", spaceType: "core" as const, enabled: true },
      { name: "Conflux eSpace Testnet", rpcUrl: "https://evmtestnet.confluxrpc.com", spaceType: "espace" as const, enabled: true },
    ];
    ...
    const now = Date.now();
    const points: Array<{ nodeId: string; metricName: string; value: number; unit: string; timestamp: number }> = [];
